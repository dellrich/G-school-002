                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Tableau de Bord cours primaire</div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="overview-panel purple">
                                        ...
                                        <div class="value white">
                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="23">{{ $teveprim }}</p>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="overview-panel  bg-b-yellow">
                                        ...
                                        <div class="value white">
                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="48">{{ $tprofprim}}</p>
                                            <p>Enseignants</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6">
                                    <div class="overview-panel bg-b-blue">
                                        ...
                                        <div class="value white">
                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="14">{{  $tmaprim }}</p>
                                            <p>Matières</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="overview-panel bg-b-green">
                                        ...
                                        <div class="value white">
                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="3421">{{ $tclassprim }}</p>
