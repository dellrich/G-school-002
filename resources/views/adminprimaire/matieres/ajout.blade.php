    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Ajout de Matiere</div>
                </div>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form id="form_sample_1" class="form-horizontal" action="{{route('matieres_prim.store')}}" method="post">
                            @csrf
                            <div class="form-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="nom_matiere" placeholder="entrez la matiere"
