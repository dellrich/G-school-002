            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form class="form-horizontal" action="{{route('inscrire_prim.update',$ins)}}" method="post" >
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="offset-md-3 col-md-9">
                                            ...
                                            <a type="button"  href="/adminprimaire/inscrire/list" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-danger">Annuler</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
