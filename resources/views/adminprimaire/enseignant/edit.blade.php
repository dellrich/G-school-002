    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Modifier un Enseignant</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Modification d'un Enseignant</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form  id="form_sample_1" class="form-horizontal" action="{{route('enseignant.update',$profs->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <img style="max-width:75px; max-height:75px;" alt="image" src="{{asset('storage/app/public/enseignant_photo')}}/{{$profs->photo}}">
                                    ...
                                    <div class="row">
                                        <div class="offset-md-3 col-md-9">
                                            <button type="submit"
                                                ...
                                                <a type="button"  href="/adminprimaire/enseignant/liste"
