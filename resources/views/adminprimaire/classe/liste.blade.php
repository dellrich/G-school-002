                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group">
                                                        <a href="/adminprimaire/classe/ajout" id="addRow"
                                                ...
                                                <tbody>
                                                    @foreach ($classes as $classes)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a type="button" href="{{route('classes_prim.edit',$classes->id)}}" class="tblEditBtn">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a class="tblDelBtn" href="{{route('classes_prim.delete',$classes->id)}}">
