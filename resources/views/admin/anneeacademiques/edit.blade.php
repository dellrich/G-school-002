            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form  id="form_sample_1" class="form-horizontal" action="{{route('anneeacademiques.update',$anneeacademiques->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="offset-md-3 col-md-9">
                                            ...
                                            <a  type="button" href="/admin/anneeacademiques/liste"
