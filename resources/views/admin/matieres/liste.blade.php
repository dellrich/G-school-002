                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group">
                                                        <a href="/admin/matieres/ajout" id="addRow"
                                                    ...
                                                    @foreach ($matieres as $matieres)
                                                        <tr>
                                                          ...
                                                          <td>#</td>
                                                            ...
                                                            <td>
                                                                <a type="button" href="{{route('matieres.edit',$matieres->id)}}" class="tblEditBtn">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a class="tblDelBtn" href="{{route('matieres.delete',$matieres->id)}}">
