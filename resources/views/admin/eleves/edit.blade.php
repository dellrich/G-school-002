        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="{{route('eleve.index')}}">Eleves</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form action="{{route('eleve.update',$eleves->id)}}" id="" class="form-horizontal" method="POST">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="offset-md-3 col-md-9">
                                            ...
                                            <a type="button"  href="/admin/eleves/liste" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-danger">Annuler</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
