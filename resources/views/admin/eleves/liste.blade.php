                                                    ...
                                                    @foreach ($eleves as $eleve)
                                                        <tr class="odd gradeX">
                                                            <td class="patient-img">
                                                                @if ($eleve->id_sexe == 1)
                                                                    <img src="{{asset('assets/img/user/masculin.png')}}" alt="">
                                                                @else
                                                                    <img src="{{asset('assets/img/user/feminin.png')}}" alt="">
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td>{{$eleve->sexe->libelle}}</td>
                                                            <td>{{$eleve->adresse}}</td>
                                                            <td>{{$eleve->contact_parent}}</td>
                                                            <td>
                                                                <a href="{{route('eleve.edit', $eleve->id)}}" class="tblEditBtn">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a class="tblDelBtn delete-confirm" href="{{route('eleve.delete', $eleve->id)}}">
