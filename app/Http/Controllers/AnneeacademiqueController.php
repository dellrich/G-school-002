...
class AnneeacademiqueController extends Controller
{
    ...
    {
        return view('admin/anneeacademiques.ajout');
    }

    public function index()
    {
        $anneeacademiques = Anneeacademique::all();
        return view('admin/anneeacademiques.liste', compact('anneeacademiques'));
    }
       ...
       // dd($annnee);
        ...
        if ($dejaanne == null) {
            ...
            if ($anneeacademiques) {
                ...
                return redirect()->route('anneeacademiques.liste');
            }
        } else{
    ...
    public function edit($id)
    {
        ...
        return view('admin.anneeacademiques.edit', compact('anneeacademiques'));
    }
